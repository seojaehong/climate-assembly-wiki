...
import { bannerView, type CountdownTier } from './topic-countdown';
...
export default function DeadlineBanner({
  ...
  /** HomeScreen의 단일 세션 상태에서 받은 마지막 정상 목록. 이 컴포넌트는 I/O를 하지 않는다. */
  topics: readonly Topic[] | null;
  /** 같은 topic_list 응답의 server_now로 계산한 오프셋. */
  ...
  const view = bannerView(topics, nowMs, serverClockOffsetMs, unsavedTopicIds);
  ...
  return (
    <div
      ...
      className={`-mx-1 mb-3 rounded-2xl border-2 px-4 py-3 shadow-sm ${tone.box}`}
    >
