...
3. 추가 투표가 실제로 필요해지면, 새 Form을 즉석 생성하기보다 기존 의제투표 Form 선택지를 바꾸지 말고 별도 quick-vote Form으로 분리하는 것이 안전하다.
4. 현장 담당자용 매뉴얼에는 복잡한 분기 설명을 넣지 않고, 진행자가 안내하는 QR만 사용하라고 안내한다.
