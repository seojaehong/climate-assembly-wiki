...
- **설계 마법사(Phase 3)**: 승인 전 로컬 청사진 작성·검증·JSON export는 구현했다. 실제 assembly/session/topic/team 생성 RPC, 서버 저장·불러오기와 기관별 권한은 플랜상 Phase 2(tenancy) 이후이며 §5-4 결정과 DB 변경 승인이 필요하다.
