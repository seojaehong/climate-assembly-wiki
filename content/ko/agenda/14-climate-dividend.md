...
title: "시민 환급형 기후배당(Climate Dividend) 도입"
category: 실행-의제
status: proposed
sessions: [2026-05-28]
related_agendas: [2, 6]
ministries: [기획재정부, 기후에너지환경부]
international_cases: [Canada (2019~), Switzerland, Austria]
...
- [의제 ② 전기요금 인상](/ko/agenda/electricity-price/)
- [의제 ⑥ 라이프스타일 규제](/ko/agenda/lifestyle-regulation/)
- 박찬 1교시 강의안 정리(`1교시_박찬교수_강의안_정리.docx`) p.49
- Canada Climate Action Incentive Payment (정부 자료)
...
- [1교시 박찬 교수 — 정부의 기후위기 대응정책](/ko/doc/lecture-1-park-chan/) (의제군 B '탄소중립 전환비용 확보 — 기후배당' 직접 기반)
