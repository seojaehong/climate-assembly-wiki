...
begin
  ...
  with expected(ordinal, block, prompt, guidance) as (
    values
      ...
      (6, 'pm', '정책제안 정리·일정·대표 제목·기타 의견', '9/13(일) 2일차 13:00~14:15 · 정책제안, 추진 일정, 대표 제목과 기타 의견을 하나의 초안 묶음으로 정리합니다.'),
      (7, 'pm', '5개 원칙 확인·기타 의견·반대 의견', '9/13(일) 2일차 14:30~15:30 · 도슨트 방식의 4회 검토 후 5개 원칙과 기타·반대 의견을 빠짐없이 기록합니다.'),
      (8, 'pm', '중복 유형·대표 제목·제8차 이관 메모', '9/13(일) 2일차 15:45~16:45 · 조별 공유 결과와 중복 유형 A·B·C·D, 대표 제목, 미완성 초안의 제8차 이관 메모를 남깁니다.')
  )
  select count(*)
    into v_bad
    from expected e
