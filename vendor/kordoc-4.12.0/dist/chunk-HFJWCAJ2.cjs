...
var _chunkTROD36DKcjs = require('./chunk-TROD36DK.cjs');
...
function getOcrModelsDir() {
  return _chunkTROD36DKcjs.getModelsDir.call(void 0, "ppocr");
}
async function ensureOcrModels(onProgress) {
  return _chunkTROD36DKcjs.ensureModelsIn.call(void 0, getOcrModelsDir(), ALL_OCR_MODELS, onProgress);
}
...
function ocrItemsToBlocks(items, pageNumber, pdfW, pdfH, scale, extraLines, detectTables = true) {
  ...
  return _chunkAT23GFSKcjs.extractPageBlocksWithLines.call(void 0, norm, pageNumber, { fnArray: [], argsArray: [] }, pdfW, pdfH, extraLines, detectTables);
}
...
//# sourceMappingURL=chunk-HFJWCAJ2.cjs.map