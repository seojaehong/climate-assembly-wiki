...
var FormulaPipeline = class _FormulaPipeline {
  ...
  static async create(options) {
    const opts = {
      scale: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _2 => _2.scale]), () => ( RENDER_SCALE)),
      maxRegionsPerPage: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _3 => _3.maxRegionsPerPage]), () => ( 50)),
      pageTimeoutMs: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _4 => _4.pageTimeoutMs]), () => ( 6e4))
    };
    ...
    const modelsDir = _chunkTROD36DKcjs.getFormulaModelsDir.call(void 0, );
    const mfdPath = _path.join.call(void 0, modelsDir, _chunkTROD36DKcjs.MFD_MODEL.filename);
    const encPath = _path.join.call(void 0, modelsDir, _chunkTROD36DKcjs.MFR_ENCODER_MODEL.filename);
    const decPath = _path.join.call(void 0, modelsDir, _chunkTROD36DKcjs.MFR_DECODER_MODEL.filename);
    const tokPath = _path.join.call(void 0, modelsDir, _chunkTROD36DKcjs.MFR_TOKENIZER.filename);
    const sessionOpts = {
  ...
  async runOnBuffer(buffer, pageFilter = null, onPageProgress) {
    ...
    try {
      ...
      for (const page of doc.pages()) {
        ...
        _optionalChain([onPageProgress, 'optionalCall', _5 => _5(pageNo, doc.getPageCount())]);
        try {
          ...
          process.stderr.write(
            `[kordoc-formula] page ${pageNo} skipped: ${e.message}
`
          );
        }
      }
...
exports.ALL_FORMULA_MODELS = _chunkTROD36DKcjs.ALL_FORMULA_MODELS; exports.FormulaPipeline = FormulaPipeline; exports.MFD_MODEL = _chunkTROD36DKcjs.MFD_MODEL; exports.MFR_DECODER_MODEL = _chunkTROD36DKcjs.MFR_DECODER_MODEL; exports.MFR_ENCODER_MODEL = _chunkTROD36DKcjs.MFR_ENCODER_MODEL; exports.MFR_TOKENIZER = _chunkTROD36DKcjs.MFR_TOKENIZER; exports.ensureFormulaModels = _chunkTROD36DKcjs.ensureFormulaModels; exports.ensureSingleModel = _chunkTROD36DKcjs.ensureSingleModel; exports.getFormulaModelStatus = _chunkTROD36DKcjs.getFormulaModelStatus; exports.getFormulaModelsDir = _chunkTROD36DKcjs.getFormulaModelsDir; exports.postProcessLatex = postProcessLatex;
//# sourceMappingURL=formula-YMGXXRBQ.cjs.map