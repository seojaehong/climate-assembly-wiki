...
function newPageNumCtrl(num2 = 1) {
  return `<hp:ctrl><hp:newNum num="${num2}" numType="PAGE"/></hp:ctrl>`;
}
...
async function parseImage(buffer, options) {
  try {
    const { parseImageDocument } = await import("./image-ocr-M4RP4INO.js");
...
async function parsePdf(buffer, options) {
  ...
  try {
    const mod = await import("./parser-NR3XO4SM.js");
...
//# sourceMappingURL=chunk-PFUW4I4I.js.map